...
subp1 = subplot(1, 2, 1)
uEnergy = plot(0:energyRangeEnd-1, kinEnergy(1:energyRangeEnd), 'b', 'Linewidth' , 1.5);
hold on;
cEnergy = plot(0:energyRangeEnd-1, connEnergy(1:energyRangeEnd), 'r', 'Linewidth', 1.5);

tot = plot(0:energyRangeEnd-1, totEnergy(1:energyRangeEnd) , 'k', 'Linewidth' , 1.5);
